...
import com.jorge.bookpedia.book.presentation.book_detail.components.BlurredImageBackground
import com.jorge.bookpedia.book.presentation.book_detail.components.BookChip
import com.jorge.bookpedia.book.presentation.book_detail.components.ChipSize
import com.jorge.bookpedia.book.presentation.book_detail.components.TitledContent
...
fun BookDetailScreen(
    ...
    effect: SharedFlow<BookDetailEffect>,
    ...
    LaunchedEffect(Unit) {
        effect.collectLatest { effect ->
            when (effect) {
                BookDetailEffect.NavigateBack -> onNavigateBack()
            }
        }
    }
